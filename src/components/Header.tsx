...
import { Play, Square, RefreshCw, Activity, Wallet, Globe, Copy, Check, Radio, BrainCircuit } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navTabs = [
    ...
    { id: 'ai', label: 'AI İyileştir', icon: BrainCircuit },
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 flex items-center overflow-x-auto scrollbar-hide touch-pan-x py-0.5">
          {navTabs.map((tab) => {
            ...
            return (
              ...
              >
                {tab.icon ? <tab.icon className="w-3.5 h-3.5 mr-1.5 inline" /> : null}{tab.label}
              </button>
            );
          })}
        </div>
